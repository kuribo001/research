...
- Co dataset phu hop de bat dau demo voi `Tokyo Toei`.
...
- Da duoc quyet dinh la operator chinh cho `Tokyo`
...
- `Tokyo Metro`: phuong an mo rong sau `Toei`
...
- Phase 2 tap trung `Toei` cho trip/realtime.
...
7. Optional: Tokyo Metro static + alert
...
- `Tokyo Metro` la phuong an mo rong sau khi `Toei` on dinh
