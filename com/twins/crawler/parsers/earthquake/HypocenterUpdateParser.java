...
public final class HypocenterUpdateParser extends AbstractEarthquakeParser {
    private static final String MESSAGE_CODE = "VXSE61";

    @Override
    public EarthquakeMessageFamily family() {
        return EarthquakeMessageFamily.HYPOCENTER_UPDATE;
    }
